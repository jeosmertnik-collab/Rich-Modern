...
public class Potions extends AbstractHudElement {
    ...
    public void drawDraggable(DrawContext context, int alpha) {
        ...
        if (showExample) {
            ...
            float timerWidth = Fonts.SFPRO_REGULAR.getWidth(exampleTimer, 6);
            float nameWidth = Fonts.SFPRO_REGULAR.getWidth(name, 6);
            float levelWidth = Fonts.REGULAR.getWidth(levelText, 6);
            ...
            for (Map.Entry<String, Float> entry : effectAnimations.entrySet()) {
                ...
                float timerWidth = Fonts.SFPRO_REGULAR.getWidth(timer, 6);
        ...
        float countTextWidth = Fonts.SFPRO_REGULAR.getWidth(countText, 6);
        float potionsTextWidth = Fonts.SFPRO_REGULAR.getWidth("Potions", 6);
        ...
        if (showExample) {
            ...
            float nameX = x + 20;
            Fonts.SFPRO_REGULAR.draw(name, nameX, y + moduleOffset - 1.5f, 6,
                    new Color(220, 230, 255, bgAlpha).getRGB());

            float nameWidth = Fonts.SFPRO_REGULAR.getWidth(name, 6);

            Fonts.HUD_ICONS.draw(levelText, nameX + nameWidth + 2, y + moduleOffset - 0.5f, 5,
            ...
            for (Map.Entry<String, Float> entry : effectAnimations.entrySet()) {
                ...
                Render2D.gradientRect(timerBoxX, y + moduleOffset - 2f, timerWidth + 4, 9,
                        new int[]{
                                new Color(35, 40, 50, blinkAlpha).getRGB(),
                                new Color(25, 30, 40, blinkAlpha).getRGB(),
                                new Color(35, 40, 50, blinkAlpha).getRGB(),
                                new Color(25, 30, 40, blinkAlpha).getRGB()
                        },
                        4);
                ...
                float nameX = x + 20;
                Fonts.SFPRO_REGULAR.draw(name, nameX, y + moduleOffset - 1.5f, 6, textColor);

                if (amplifier > 0) {
                    float nameWidth = Fonts.SFPRO_REGULAR.getWidth(name, 6);
                    Fonts.HUD_ICONS.draw(levelText, nameX + nameWidth + 2, y + moduleOffset - 0.5f, 5, levelColor);
                }

                Fonts.SFPRO_REGULAR.draw(timer, timerBoxX + 2, y + moduleOffset - 1, 6, timerColor);
