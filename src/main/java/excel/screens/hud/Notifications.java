...
public class Notifications extends AbstractHudElement {
    ...
    public void drawDraggable(DrawContext context, int alpha) {
        ...
        for (Notification notification : list) {
            ...
            float textWidth = Fonts.SFPRO_REGULAR.getWidth(notification.text, 6);
            float width = textWidth + offsetX * 2 + 10;
            ...
            if (bgAlpha > 0) {
                int transparentBg = (int)(bgAlpha * 0.53f);
                
                Render2D.gradientRect(startX, startY, width, NOTIFICATION_HEIGHT,
                        new int[]{
                                new Color(25, 30, 40, transparentBg).getRGB(),
                                new Color(15, 20, 30, transparentBg).getRGB(),
                                new Color(25, 30, 40, transparentBg).getRGB(),
                                new Color(15, 20, 30, transparentBg).getRGB()
                        }, 4);
