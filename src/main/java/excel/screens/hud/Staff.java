...
public class Staff extends AbstractHudElement {
    ...
    private static final Identifier STEVE_SKIN = Identifier.of("excel", "textures/entity/player/wide/steve.png");
    ...
    public void drawDraggable(DrawContext context, int alpha) {
        ...
        if (showExample) {
            ...
            for (Map.Entry<String, Float> entry : staffAnimations.entrySet()) {
                ...
                float nameWidth = Fonts.SFPRO_REGULAR.getWidth(info.name, 6);
                targetWidth = Math.max(nameWidth + 55, targetWidth);
            }
        }
        ...
        if (showExample) {
            ...
            Fonts.SFPRO_REGULAR.draw(name, nameX, y + moduleOffset - 1.5f, 6, new Color(220, 230, 255, bgAlpha).getRGB());
            ...
            for (Map.Entry<String, Float> entry : staffAnimations.entrySet()) {
                ...
                Fonts.SFPRO_REGULAR.draw(info.name, nameX, y + moduleOffset - 1.5f, 6, new Color(220, 230, 255, textAlpha).getRGB());
    ...
    private void drawStatusCircle(float circleX, float circleY, int alpha) {
        Render2D.gradientRect(circleX - 3, circleY - 2, 11, 9,
                new int[]{
                        new Color(35, 40, 50, alpha).getRGB(),
                        new Color(25, 30, 40, alpha).getRGB(),
                        new Color(35, 40, 50, alpha).getRGB(),
                        new Color(25, 30, 40, alpha).getRGB()
                },
                4);
