...
public class RegisterScreen extends Screen {
    ...
    private static final float CARD_HEIGHT = 370;
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        String subtitle = "Create account";
        ...
        renderButton(context, fieldX, fieldY, fieldW, "Create Account", 0xFF6366F1);
    ...
    private float renderInput(DrawContext context, float x, float y, float w, String label, String value, boolean focused) {
        ...
        if (!value.isEmpty()) {
            ...
            if (label.contains("Confirm")) {
                ...
                placeholder = "3-16 characters, letters and numbers";
            }
    ...
    private void submitForm() {
        ...
        loading = true;
        statusMessage = "";
        AuthManager.getInstance().register(nickname, password, confirmPassword).thenAccept(result -> {
            loading = false;
