package excel.util.render.font;
...
public class FontRenderer {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger("excel/FontRenderer");
    ...
    public void loadFont(String name, String path) {
        Identifier jsonId = Identifier.of("excel", "fonts/" + path + ".json");
        Identifier textureId = Identifier.of("excel", "fonts/" + path + ".png");
