...
public class FontPipeline {
    ...
    private static final Identifier PIPELINE_ID = Identifier.of("excel", "pipeline/msdf");
    private static final Identifier SHADER_ID = Identifier.of("excel", "core/msdf");
