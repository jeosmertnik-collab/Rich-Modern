    ...
    public static void init() {
        ...
        try {
            pipeline = RenderPipeline.builder()
                    .withLocation(Identifier.of("excel", "core/arc_outline"))
                    .withVertexShader(Identifier.of("excel", "core/arc_outline_vertex"))
                    .withFragmentShader(Identifier.of("excel", "core/arc_outline_fragment"))
