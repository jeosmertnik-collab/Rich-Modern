...
public class GlassCompositePipeline {
    ...
    private static final Identifier PIPELINE_ID = Identifier.of("excel", "pipeline/glass_composite");
    private static final Identifier VERTEX_SHADER = Identifier.of("excel", "core/glass_composite");
    private static final Identifier FRAGMENT_SHADER = Identifier.of("excel", "core/glass_composite");
