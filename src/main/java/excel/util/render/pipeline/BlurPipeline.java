...
public class BlurPipeline {
    ...
    private static final Identifier PIPELINE_ID = Identifier.of("excel", "pipeline/blur");
    private static final Identifier VERTEX_SHADER = Identifier.of("excel", "core/blur");
    private static final Identifier FRAGMENT_SHADER = Identifier.of("excel", "core/blur");
