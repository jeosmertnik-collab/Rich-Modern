...
public class GlowOutlinePipeline {
    ...
    private static final Identifier PIPELINE_ID = Identifier.of("excel", "pipeline/glow_outline");
    private static final Identifier VERTEX_SHADER = Identifier.of("excel", "core/glow_outline");
    private static final Identifier FRAGMENT_SHADER = Identifier.of("excel", "core/glow_outline");
