...
public class MaskDiffPipeline {
    ...
    private static final Identifier PIPELINE_ID = Identifier.of("excel", "pipeline/mask_diff");
    private static final Identifier VERTEX_SHADER = Identifier.of("excel", "core/mask_diff");
    private static final Identifier FRAGMENT_SHADER = Identifier.of("excel", "core/mask_diff");
