...
public class OutlinePipeline {
    ...
    private static final Identifier PIPELINE_ID = Identifier.of("excel", "pipeline/outline");
    private static final Identifier VERTEX_SHADER = Identifier.of("excel", "core/outline");
    private static final Identifier FRAGMENT_SHADER = Identifier.of("excel", "core/outline");
