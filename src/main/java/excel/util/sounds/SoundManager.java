...
public class SoundManager implements IMinecraft {
    public SoundEvent KOLOKOLNIA_KILL = SoundEvent.of(Identifier.of("excel:kolokolnia_kill"));
    public SoundEvent MOAN1 = SoundEvent.of(Identifier.of("excel:moan1"));
    public SoundEvent MOAN2 = SoundEvent.of(Identifier.of("excel:moan2"));
    public SoundEvent MOAN3 = SoundEvent.of(Identifier.of("excel:moan3"));
    public SoundEvent MOAN4 = SoundEvent.of(Identifier.of("excel:moan4"));
    public SoundEvent MODULE_DISABLE = SoundEvent.of(Identifier.of("excel:module_disable"));
    public SoundEvent MODULE_ENABLE = SoundEvent.of(Identifier.of("excel:module_enable"));
    public SoundEvent OFF = SoundEvent.of(Identifier.of("excel:off"));
    public SoundEvent ON = SoundEvent.of(Identifier.of("excel:on"));
    public SoundEvent CRIME = SoundEvent.of(Identifier.of("excel:crime"));
    public SoundEvent METALLIC = SoundEvent.of(Identifier.of("excel:metallic"));
    public SoundEvent WELCOME = SoundEvent.of(Identifier.of("excel:welcome"));
