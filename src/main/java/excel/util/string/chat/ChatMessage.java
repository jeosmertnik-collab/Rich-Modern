package excel.util.string.chat;
...
import excel.util.string.chat.helper.TextHelper;

public class ChatMessage {
    public static MutableText brandmessage() {
        return (MutableText) TextHelper.applyPredefinedGradient("Excel Client", "black_light_purple", true);
    }
    ...
    public static void brandmessage(String message) {
        if (MinecraftClient.getInstance().player != null) {
            Text prefix = TextHelper.applyPredefinedGradient("Excel Client -> ", "black_light_purple", true);
