...
public class ParticleRenderer {
    ...
    private static final Identifier GLOW_TEXTURE = Identifier.of("excel", "textures/world/dashbloom.png");
    private static final Identifier GLOW_TEXTURE_SECONDARY = Identifier.of("excel", "textures/world/dashbloomsample.png");
