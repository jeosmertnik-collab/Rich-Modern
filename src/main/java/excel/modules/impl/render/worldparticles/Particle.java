package excel.modules.impl.render.worldparticles;
...
import excel.util.animations.EaseInOutQuad;
...
public class Particle implements IMinecraft {
    ...
    private static final Identifier TEXTURE_CROWN = Identifier.of("excel", "textures/world/crown.png");
    private static final Identifier TEXTURE_CUBE_BLAST = Identifier.of("excel", "textures/world/cubeblast1.png");
    private static final Identifier TEXTURE_DOLLAR = Identifier.of("excel", "textures/world/dollar.png");
    private static final Identifier TEXTURE_HEART = Identifier.of("excel", "textures/world/heart.png");
    private static final Identifier TEXTURE_LIGHTNING = Identifier.of("excel", "textures/world/lightning.png");
    private static final Identifier TEXTURE_LINE = Identifier.of("excel", "textures/world/line.png");
    private static final Identifier TEXTURE_RHOMBUS = Identifier.of("excel", "textures/world/rhombus.png");
    private static final Identifier TEXTURE_SNOWFLAKE = Identifier.of("excel", "textures/world/snowflake.png");
    private static final Identifier TEXTURE_STAR = Identifier.of("excel", "textures/world/star.png");
    private static final Identifier TEXTURE_STAR_ALT = Identifier.of("excel", "textures/world/star1.png");
    private static final Identifier TEXTURE_TRIANGLE = Identifier.of("excel", "textures/world/triangle.png");
    private static final Identifier TEXTURE_GLOW = Identifier.of("excel", "textures/world/dashbloom.png");

    private static final Identifier GLOW_BLOOM = Identifier.of("excel", "textures/world/dashbloom.png");
    private static final Identifier GLOW_BLOOM_SAMPLE = Identifier.of("excel", "textures/world/dashbloomsample.png");
