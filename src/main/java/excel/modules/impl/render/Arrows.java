...
import excel.util.animations.Easings;
import excel.util.animations.SmoothAnimation;
...
public class Arrows extends ModuleStructure {
    ...
    private static final Identifier ARROW_TEXTURE = Identifier.of("excel", "textures/world/arrow.png");
